...
local function GetDungeonAppearances()
    ...
    local sets = {
        ...
        IncludeSet(COLLECTION,10101,359), -- Vestments of the Devout
        IncludeSet(COLLECTION,10101,1424), -- Dreadmist Raiment
        IncludeSet(COLLECTION,10101,1425), -- Magister's Regalia
        IncludeSet(COLLECTION,10101,1426), -- Wildheart Raiment
        IncludeSet(COLLECTION,10101,1427), -- Shadowcraft Armor
        IncludeSet(COLLECTION,10101,1428), -- Beaststalker Armor
        IncludeSet(COLLECTION,10101,1429), -- The Elements
        IncludeSet(COLLECTION,10101,1430), -- Lightforge Armor
        IncludeSet(COLLECTION,10101,1431), -- Battlegear of Valor
        
        -- Darkmoon Faire, Dungeon 2
        IncludeSet(COLLECTION,10102,360), -- Vestments of the Virtuous
        IncludeSet(COLLECTION,10102,854), -- Deathmist Raiment
        IncludeSet(COLLECTION,10102,855), -- Sorcerer's Regalia
        IncludeSet(COLLECTION,10102,856), -- Beastmaster Armor
        IncludeSet(COLLECTION,10102,857), -- Darkmantle Armor
        IncludeSet(COLLECTION,10102,858), -- Feralheart Raiment
        IncludeSet(COLLECTION,10102,859), -- Soulforge Armor
        IncludeSet(COLLECTION,10102,860), -- The Five Thunders
        IncludeSet(COLLECTION,10102,861), -- Battlegear of Heroism
...
local function GetRaidAppearances()
    ...
    local sets = {
        -- Molten Core 
        IncludeSet(COLLECTION,VERSION,357), -- Vestments of Prophecy
        IncludeSet(COLLECTION,VERSION,853), -- Battlegear of Might
        IncludeSet(COLLECTION,VERSION,868), -- Felheart Raiment
        IncludeSet(COLLECTION,VERSION,876), -- The Earthfury
        IncludeSet(COLLECTION,VERSION,894), -- Nightslayer Armor
        IncludeSet(COLLECTION,VERSION,902), -- Lawbringer Armor
        IncludeSet(COLLECTION,VERSION,910), -- Arcanist Regalia
        IncludeSet(COLLECTION,VERSION,917), -- Giantstalker Armor
        IncludeSet(COLLECTION,VERSION,928), -- Cenarion Raiment
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        -- Blackwing Lair
        IncludeSet(COLLECTION,VERSION,356), -- Vestments of Transcendence
        IncludeSet(COLLECTION,VERSION,852), -- Battlegear of Wrath
        IncludeSet(COLLECTION,VERSION,867), -- Nemesis Raiment
        ...
        IncludeSet(COLLECTION,VERSION,927), -- Stormrage Raiment
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        -- Temple of Ahn'Qiraj
        IncludeSet(COLLECTION,VERSION,358), -- Garments of the Oracle
        IncludeSet(COLLECTION,VERSION,851), -- Conqueror's Battlegear
        IncludeSet(COLLECTION,VERSION,866), -- Doomcaller's Attire
        IncludeSet(COLLECTION,VERSION,874), -- Stormcaller's Garb
        IncludeSet(COLLECTION,VERSION,892), -- Deathdealer's Embrace
        IncludeSet(COLLECTION,VERSION,900), -- Avenger's Battlegear
        IncludeSet(COLLECTION,VERSION,908), -- Enigma Vestments
        IncludeSet(COLLECTION,VERSION,915), -- Striker's Garb
        IncludeSet(COLLECTION,VERSION,926), -- Genesis Raiment
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        -- Naxxramas
        IncludeSet(COLLECTION,20000,355), -- Vestments of Faith
        IncludeSet(COLLECTION,20000,850), -- Dreadnaught's Battlegear
        IncludeSet(COLLECTION,20000,865), -- Plagueheart Raiment
        IncludeSet(COLLECTION,20000,873), -- The Earthshatterer
        IncludeSet(COLLECTION,20000,891), -- Bonescythe Armor
        IncludeSet(COLLECTION,20000,899), -- Redemption Armor
        IncludeSet(COLLECTION,20000,907), -- Frostfire Regalia
        IncludeSet(COLLECTION,20000,914), -- Cryptstalker Armor
        IncludeSet(COLLECTION,20000,924), -- Dreamwalker Raiment
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
end
