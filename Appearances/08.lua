...
local function GetDungeonAppearances()
    ...
    sets = {
        -- Shrine of the Storm
        IncludeSet(SetCollector.OTHER,80001,1637), -- Vestments of the Tidesages
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
end
...
local function GetExpansionAppearances()
    ...
    local sets = {
        ...
        CreateSet(COLLECTION,80004,"ISLAND_EXPEDITIONS",CLOTH,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80003,"ISLAND_EXPEDITIONS",CLOTH,ANY_FACTION,NO_LOCATION,
            CreateVariant("6",TRANSMOG,A(15745),A(15748),A(15747),A(15749),A(15744),A(15741),A(15746),A(15742))
        ),
        CreateSet(COLLECTION,80004,"ISLAND_EXPEDITIONS",LEATHER,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80003,"ISLAND_EXPEDITIONS",LEATHER,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80003,"ISLAND_EXPEDITIONS",MAIL,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80004,"ISLAND_EXPEDITIONS",PLATE,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80003,"ISLAND_EXPEDITIONS",PLATE,ANY_FACTION,NO_LOCATION,
...
local function GetLegendaries()
    ...
    local sets = {
        CreateSet(COLLECTION,80001,"LG_120",ANY_CLASS,ANY_FACTION,NO_LOCATION,
...
local function GetOtherAppearances()
    ...
    local sets = {
        ...
        CreateSet(COLLECTION,80001,"OTH_CLOTH_A_110",CLOTH,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80001,"OTH_LEATHER_A_110",LEATHER,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80001,"OTH_MAIL_A_110",MAIL,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80001,"OTH_PLATE_A_110",PLATE,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80002,"OTH_CLOTH_H_110",CLOTH,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80002,"OTH_LEATHER_H_110",LEATHER,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80002,"OTH_MAIL_H_110",MAIL,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80002,"OTH_PLATE_H_110",PLATE,ANY_FACTION,NO_LOCATION,
        ...
        -- Benthic Gear
        CreateSet(COLLECTION,80003,"OTH_CLOTH_1202",CLOTH,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80003,"OTH_LEATHER_1202",LEATHER,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80003,"OTH_MAIL_1202",MAIL,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,80003,"OTH_PLATE_1202",PLATE,ANY_FACTION,NO_LOCATION,
        ...
        IncludeSet(SetCollector.OTHER,80205,1902), -- Renowned Explorer's Attire
        -- Woolies
        IncludeSet(SetCollector.OTHER,80205,1903), -- Wendigo Woolies
        -- Progenitor's Attire
        IncludeSet(SetCollector.OTHER,80205,1913), -- Vestments of the Eternal Traveler
        -- Fae Trappings
        IncludeSet(SetCollector.OTHER,80305,1914), -- Sprite Darter's Wings

        IncludeSet(COLLECTION,10814,1822), -- Brawler's Garb
        IncludeSet(COLLECTION,10815,1823), -- Brawler's Garb
...
local function GetPvpAppearances()
    ...
    local sets = {
        ...
        IncludeSet(COLLECTION,80001,1654,1656,1655,1738), -- Dread Gladiator's Vestment, Warfront, Aspirant, Elite
        IncludeSet(COLLECTION,80001,1657,1659,1658,1737), -- Dread Gladiator's Leathers, Warfront, Aspirant, Elite
        IncludeSet(COLLECTION,80001,1660,1662,1661,1736), -- Dread Gladiator's Chain, Warfront, Aspirant, Elite
        IncludeSet(COLLECTION,80001,1663,1665,1664,1735), -- Dread Gladiator's Plate, Warfront, Aspirant, Elite
        IncludeSet(COLLECTION,80001,1666,1668,1667,1734), -- Dread Gladiator's Vestment, Warfront, Aspirant, Elite
        IncludeSet(COLLECTION,80001,1669,1671,1670,1733), -- Dread Gladiator's Leathers, Warfront, Aspirant, Elite
        ...
        IncludeSet(COLLECTION,80200,1858,1863,1859), -- Notorious Aspirant's Chain, Aspirant, Elite
        IncludeSet(COLLECTION,80200,1864,1869,1865), -- Notorious Aspirant's Plate, Aspirant, Elite
        IncludeSet(COLLECTION,80200,1879,1878,1874), -- Notorious Gladiator's Plate, Elite, Aspirant
        IncludeSet(COLLECTION,80200,1885,1884,1880), -- Notorious Gladiator's Chain, Elite, Aspirant
        IncludeSet(COLLECTION,80200,1891,1890,1886), -- Notorious Gladiator's Leathers, Elite, Aspirant
        IncludeSet(COLLECTION,80200,1897,1896,1892), -- Notorious Gladiator's Vestment, Elite, Aspirant
        -- Season 4
        IncludeSet(COLLECTION,80300,1951,1950), -- Corrupted Gladiator's Plate, Elite
        IncludeSet(COLLECTION,80300,1951,1972), -- Corrupted Gladiator's Plate, Elite
        IncludeSet(COLLECTION,80300,1957,1956), -- Corrupted Gladiator's Chain, Elite
        IncludeSet(COLLECTION,80300,1957,1973), -- Corrupted Gladiator's Chain, Elite
        IncludeSet(COLLECTION,80300,1963,1962), -- Corrupted Gladiator's Leathers, Elite
        IncludeSet(COLLECTION,80300,1963,1974), -- Corrupted Gladiator's Leathers, Elite
        IncludeSet(COLLECTION,80300,1969,1968), -- Corrupted Gladiator's Vestment, Elite
        IncludeSet(COLLECTION,80300,1969,1975), -- Corrupted Gladiator's Vestment, Elite
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
end
...
local function GetRaidAppearances()
    ...
    local sets = {
        -- Uldir
        IncludeSet(COLLECTION,80001,1638,1639,1640,1641), -- Eternal Curator's Vestment, Heroic, Mythic, Raid Finder
        IncludeSet(COLLECTION,80001,1642,1644,1643,1645), -- Eternal Curator's Garb, Mythic, Heroic, Raid Finder
        IncludeSet(COLLECTION,80001,1646,1647,1648,1649), -- Eternal Curator's Chains, Heroic, Mythic, Raid Finder
        IncludeSet(COLLECTION,80001,1650,1651,1652,1653), -- Eternal Curator's Protectorate, Heroic, Mythic, Raid Finder
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        IncludeSet(COLLECTION,80100,1806,1807,1808,1809), -- Soul Reaper's Raiment, Raid Finder, Heroic, Mythic
        IncludeSet(COLLECTION,80100,1810,1812,1811,1813), -- Boneblade Battlegear, Heroic, Raid Finder, Mythic
        IncludeSet(COLLECTION,80100,1814,1815,1816,1817), -- Death-Devourer Vestments, Raid Finder, Heroic, Mythic
        IncludeSet(COLLECTION,80100,1818,1819,1820,1821), -- Gravelord's Direplate, Raid Finder, Heroic, Mythic
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        -- The Eternal Palace
        IncludeSet(COLLECTION,80200,1830,1834,1838,1842), -- Naga Lord's Warplate, Heroic, Mythic, Raid Finder
        IncludeSet(COLLECTION,80200,1831,1839,1835,1843), -- Queen's Guard Scalemail, Mythic, Heroic, Raid Finder
        IncludeSet(COLLECTION,80200,1832,1836,1840,1844), -- Razorfin Regalia, Heroic, Mythic, Raid Finder
        IncludeSet(COLLECTION,80200,1833,1837,1841,1845), -- Frilled Harbinger's Vestments, Heroic, Mythic, Raid Finder
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        IncludeSet(COLLECTION,80300,1982,1983,1984,1985), -- Cosmic Aberration's Plate, Raid Finder, Heroic, Mythic
        IncludeSet(COLLECTION,80300,1986,1987,1988,1989), -- Lurking Defiler's Scalemail, Raid Finder, Heroic, Mythic
        IncludeSet(COLLECTION,80300,1990,1992,1991,1993), -- Treacherous Schemer's Leathers, Heroic, Raid Finder, Mythic
        IncludeSet(COLLECTION,80300,1994,1995,1996,1997), -- Oblivion Cultist's Robes, Raid Finder, Heroic, Mythic
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
end
