...
local function GetCraftedAppearances()
    ...
    local sets = {
        CreateSet(COLLECTION,90001,"CR_CLOTH_0901",CLOTH,ANY_CLASS,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90001,"CR_LEATHER_0901",LEATHER,ANY_CLASS,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90001,"CR_MAIL_0901",MAIL,ANY_CLASS,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90001,"CR_PLATE_0901",PLATE,ANY_CLASS,ANY_FACTION,NO_LOCATION,
...
local function Get90000DungeonAppearances(collection)
    ...
    local sets = {
        ...
        CreateSet(collection,90001,"DG_CLOTH_0901",CLOTH,ANY_CLASS,ANY_FACTION,LOCATION_01,
        ...
        CreateSet(collection,90001,"DG_LEATHER_0901",LEATHER,ANY_CLASS,ANY_FACTION,LOCATION_01,
        ...
        CreateSet(collection,90001,"DG_MAIL_0901",MAIL,ANY_CLASS,ANY_FACTION,LOCATION_01,
        ...
        CreateSet(collection,90001,"DG_PLATE_0901",PLATE,ANY_CLASS,ANY_FACTION,LOCATION_01,
        ...
        CreateSet(collection,90002,"DG_CLOTH_0901",CLOTH,ANY_CLASS,ANY_FACTION,LOCATION_02,
        ...
        CreateSet(collection,90002,"DG_LEATHER_0901",LEATHER,ANY_CLASS,ANY_FACTION,LOCATION_02,
        ...
        CreateSet(collection,90002,"DG_MAIL_0901",MAIL,ANY_CLASS,ANY_FACTION,LOCATION_02,
        ...
        CreateSet(collection,90002,"DG_PLATE_0901",PLATE,ANY_CLASS,ANY_FACTION,LOCATION_02,
        ...
        CreateSet(collection,90003,"DG_CLOTH_0901",CLOTH,ANY_CLASS,ANY_FACTION,LOCATION_03,
        ...
        CreateSet(collection,90003,"DG_LEATHER_0901",LEATHER,ANY_CLASS,ANY_FACTION,LOCATION_03,
        ...
        CreateSet(collection,90003,"DG_MAIL_0901",MAIL,ANY_CLASS,ANY_FACTION,LOCATION_03,
        ...
        CreateSet(collection,90003,"DG_PLATE_0901",PLATE,ANY_CLASS,ANY_FACTION,LOCATION_03,
        ...
        CreateSet(collection,90004,"DG_CLOTH_0901",CLOTH,ANY_CLASS,ANY_FACTION,LOCATION_04,
        ...
        CreateSet(collection,90004,"DG_LEATHER_0901",LEATHER,ANY_CLASS,ANY_FACTION,LOCATION_04,
        ...
        CreateSet(collection,90004,"DG_MAIL_0901",MAIL,ANY_CLASS,ANY_FACTION,LOCATION_04,
        ...
        CreateSet(collection,90004,"DG_PLATE_0901",PLATE,ANY_CLASS,ANY_FACTION,LOCATION_04,
...
local function Get90100DungeonAppearances(collection)
    ...
    local sets = {
        ...
        CreateSet(collection,90005,"DG_CLOTH_0901",CLOTH,ANY_CLASS,ANY_FACTION,LOCATION_05,
            CreateVariant("LOC_DG_0905",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A())
        ),
        CreateSet(collection,90005,"DG_LEATHER_0901",LEATHER,ANY_CLASS,ANY_FACTION,LOCATION_05,
            CreateVariant("LOC_DG_0905",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A())
        ),
        CreateSet(collection,90005,"DG_MAIL_0901",MAIL,ANY_CLASS,ANY_FACTION,LOCATION_05,
            CreateVariant("LOC_DG_0905",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A())
        ),
        CreateSet(collection,90005,"DG_PLATE_0901",PLATE,ANY_CLASS,ANY_FACTION,LOCATION_05,
            CreateVariant("LOC_DG_0905",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A())
        ),
    }
    AddSetsToDatabase(VERSION, collection, sets)
...
local function GetExpansionAppearances()
    ...
    local sets = {
        ...
        -- Pre-patch Set
        CreateSet(COLLECTION,90000,"EX_CLOTH_A_0900",CLOTH,ANY_CLASS,ALLIANCE,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90000,"EX_LEATHER_A_0900",LEATHER,ANY_CLASS,ALLIANCE,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90000,"EX_MAIL_A_0900",MAIL,ANY_CLASS,ALLIANCE,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90000,"EX_PLATE_A_0900",PLATE,ANY_CLASS,ALLIANCE,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90000,"EX_CLOTH_H_0900",CLOTH,ANY_CLASS,HORDE,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90000,"EX_LEATHER_H_0900",LEATHER,ANY_CLASS,HORDE,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90000,"EX_MAIL_H_0900",MAIL,ANY_CLASS,HORDE,NO_LOCATION,
        ...
        CreateSet(COLLECTION,90000,"EX_PLATE_H_0900",PLATE,ANY_CLASS,HORDE,NO_LOCATION,
        ...
        -- Covenants
        -- Night Fae
        IncludeSet(COLLECTION,90001,2047,CLOTH,ANY_CLASS,ANY_FACTION,2050,2048,2049), -- Winterborn Regalia, Winterborn, Renown, Queen's Conservatory
        IncludeSet(COLLECTION,90001,2051,LEATHER,ANY_CLASS,ANY_FACTION,2053,2052,2054), -- Night Courtier's Raiment, Winterborn, Queen's Conservatory, Renown
        IncludeSet(COLLECTION,90001,2055,MAIL,ANY_CLASS,ANY_FACTION,2056,2057,2058), -- Winterborn Guise, Queen's Conservatory, Renown, Winterborn
        IncludeSet(COLLECTION,90001,2059,PLATE,ANY_CLASS,ANY_FACTION,2061,2060,2062), -- Conservator's Warbark, Winterborn, Renown, Queen's Conservatory

        -- Kyrian
        IncludeSet(COLLECTION,90001,2015,CLOTH,ANY_CLASS,ANY_FACTION,2016,2017,2018), -- Vestments of the Discordant, Renown, Path of Ascension, Path of Ascension
        IncludeSet(COLLECTION,90001,2019,LEATHER,ANY_CLASS,ANY_FACTION,2020,2021,2022), -- Garb of the Discordant, Renown, Path of Ascension, Path of Ascension
        IncludeSet(COLLECTION,90001,2023,MAIL,ANY_CLASS,ANY_FACTION,2025,2024,2026), -- Chain of the Reverent, Renown, Path of Ascension, Path of Ascension
        IncludeSet(COLLECTION,90001,2029,PLATE,ANY_CLASS,ANY_FACTION,2028,2027,2030), -- Warplate of the Harmonious, Path of Ascension, Path of Ascension, Renown

        -- Venthyr
        IncludeSet(COLLECTION,90001,2066,CLOTH,ANY_CLASS,ANY_FACTION,2065,2064,2063), -- Soulbreaker's Ebony Vestments, Ember Court, Travel Network, Renown
        IncludeSet(COLLECTION,90001,2070,LEATHER,ANY_CLASS,ANY_FACTION,2068,2067,2069), -- Ebony Death Shroud Armor, Ember Court, Renown, Travel Network
        IncludeSet(COLLECTION,90001,2071,MAIL,ANY_CLASS,ANY_FACTION,2073,2072,2074), -- Fearstalker's Crimson Battlegear, Travel Network, Ember Court, Renown
        IncludeSet(COLLECTION,90001,2075,PLATE,ANY_CLASS,ANY_FACTION,2077,2076,2078), -- Dread Sentinel's Crimson Battleplate, Ember Court, Travel Network, Renown

        -- Necrolord
        IncludeSet(COLLECTION,90001,2032,CLOTH,ANY_CLASS,ANY_FACTION,2031,2033,2034), -- Horror of Maldraxxus, Renown, Unity, Abominable Stitching
        IncludeSet(COLLECTION,90001,2035,LEATHER,ANY_CLASS,ANY_FACTION,2037,2036,2038), -- Zeal of Maldraxxus, Abominable Stitching, Renown, Unity
        IncludeSet(COLLECTION,90001,2041,MAIL,ANY_CLASS,ANY_FACTION,2040,2039,2042), -- Alacrity of Maldraxxus, Abominable Stitching, Unity, Renown
        IncludeSet(COLLECTION,90001,2043,PLATE,ANY_CLASS,ANY_FACTION,2044,2045,2046), -- Mettle of Maldraxxus, Renown, Abominable Stitching, Unity
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        IncludeSet(COLLECTION,90100,2205,ANY_ARMOR,ANY_CLASS,ANY_FACTION,2203,2202,2204), -- Garb of Pure Spirit, Korthia, Renown Quartermaster, Death's Advance

        -- Aspirant's Regalia
        IncludeSet(COLLECTION,90100,2208,ANY_ARMOR,ANY_CLASS,ANY_FACTION,2206,2207,2209), -- Devoted Aspirant's Regalia, Death's Advance, Korthia, Renown Quartermaster

        -- Necromantic Vestments
        IncludeSet(COLLECTION,90100,2212,ANY_ARMOR,ANY_CLASS,ANY_FACTION,2211,2210,2213), -- Rogue Necromancer's Vestments, Renown Quartermaster, Death's Advance, Korthia

        -- Court Attire
        IncludeSet(COLLECTION,90100,2214,ANY_ARMOR,ANY_CLASS,ANY_FACTION,2215,2216,2217), -- Sinful Venthyr Attire, Death's Advance, Korthia, Renown Quartermaster

        -- Inquisitor's Vestments
        IncludeSet(COLLECTION,90100,2218,ANY_ARMOR,ANY_CLASS,ANY_FACTION,2220,2219,2221), -- Sinful Inquisitor's Vestments, Korthia, Death's Advance, Renown Quartermaster        
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)

    VERSION = 90205
    sets = {
        IncludeSet(COLLECTION,90205,2481,PLATE,PALADIN,ANY_FACTION), -- Blood Knight's Dedication
        IncludeSet(COLLECTION,90205,2484,MAIL,HUNTER,ANY_FACTION), -- Dark Ranger's Attire
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
...
local function GetOtherAppearances()
    ...
    local sets = {
        -- Leveling Sets
        CreateSet(COLLECTION,VERSION,"OTH_CLOTH_10900",CLOTH,ANY_CLASS,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,VERSION,"OTH_LEATHER_10900",LEATHER,ANY_CLASS,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,VERSION,"OTH_MAIL_10900",MAIL,ANY_CLASS,ANY_FACTION,NO_LOCATION,
        ...
        CreateSet(COLLECTION,VERSION,"OTH_PLATE_10900",PLATE,ANY_CLASS,ANY_FACTION,NO_LOCATION,
        ...
        IncludeSet(SetCollector.OTHER,90100,2200,ANY_ARMOR,ANY_CLASS,ANY_FACTION), -- Celestial Observer's Ensemble
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        CreateSet(COLLECTION,VERSION,"OTH_CLOTH_10902",CLOTH,ANY_CLASS,ANY_FACTION,NO_LOCATION,
            CreateVariant("LOC_KORTHIA",TRANSMOG,A(55591),A(55592),A(55593),A(55594),A(55595),A(55597),A(55598),A(55599),A(55596))
        ),
        CreateSet(COLLECTION,VERSION,"OTH_LEATHER_10902",LEATHER,ANY_CLASS,ANY_FACTION,NO_LOCATION,
            CreateVariant("LOC_KORTHIA",TRANSMOG,A(55583),A(),A(55582),A(55584),A(55588),A(55585),A(55587),A(55589),A(55586))
        ),
        CreateSet(COLLECTION,VERSION,"OTH_MAIL_10902",MAIL,ANY_CLASS,ANY_FACTION,NO_LOCATION,
            CreateVariant("LOC_KORTHIA",TRANSMOG,A(55574),A(55573),A(55576),A(55580),A(55575),A(55581),A(55577),A(55578),A(55579))
        ),
        CreateSet(COLLECTION,VERSION,"OTH_PLATE_10902",PLATE,ANY_CLASS,ANY_FACTION,NO_LOCATION,
    ...
    sets = {
        ...
        CreateSet(COLLECTION,VERSION,"OTH_CLOTH_10904",CLOTH,ANY_CLASS,ANY_FACTION,"LOC_ZERETH_MORTIS",
        ...
        CreateSet(COLLECTION,VERSION,"OTH_LEATHER_10904",LEATHER,ANY_CLASS,ANY_FACTION,"LOC_ZERETH_MORTIS",
        ...
        CreateSet(COLLECTION,VERSION,"OTH_MAIL_10904",MAIL,ANY_CLASS,ANY_FACTION,"LOC_ZERETH_MORTIS",
        ...
        CreateSet(COLLECTION,VERSION,"OTH_PLATE_10904",PLATE,ANY_CLASS,ANY_FACTION,"LOC_ZERETH_MORTIS",
        ...
        IncludeSet(COLLECTION,90105,2292,PLATE,ANY_CLASS,ANY_FACTION), -- Ravencrest's Battleplate
    ...
    sets = {
            ...
            IncludeSet(SetCollector.OTHER,90205,2482,ANY_ARMOR,ANY_CLASS,ANY_FACTION), -- Fireplume Regalia
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
end
...
local function GetPvPAppearances()
    ...
    local sets = {
        ...
        IncludeSet(SetCollector.PVP,90002,2170,CLOTH,ANY_CLASS,ANY_FACTION,2174), -- Sinful Aspirant's Vestment, Aspirant
        IncludeSet(SetCollector.PVP,90002,2171,LEATHER,ANY_CLASS,ANY_FACTION,2175), -- Sinful Aspirant's Leathers, Aspirant
        IncludeSet(SetCollector.PVP,90002,2172,MAIL,ANY_CLASS,ANY_FACTION,2176), -- Sinful Aspirant's Chain, Aspirant
        IncludeSet(SetCollector.PVP,90002,2173,PLATE,ANY_CLASS,ANY_FACTION,2177), -- Sinful Aspirant's Plate, Aspirant
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        IncludeSet(SetCollector.PVP,90100,2224,CLOTH,ANY_CLASS,ANY_FACTION,2228,2246), -- Unchained Aspirant's Vestment, Elite, Aspirant
        IncludeSet(SetCollector.PVP,90100,2226,MAIL,ANY_CLASS,ANY_FACTION,2230,2248), -- Unchained Aspirant's Chain, Elite, Aspirant
        IncludeSet(SetCollector.PVP,90100,2225,LEATHER,ANY_CLASS,ANY_FACTION,2229,2247), -- Unchained Aspirant's Leathers, Elite, Aspirant
        IncludeSet(SetCollector.PVP,90100,2227,PLATE,ANY_CLASS,ANY_FACTION,2231,2249), -- Unchained Aspirant's Plate, Elite, Aspirant
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        IncludeSet(SetCollector.PVP,90200,2498,PLATE,DEATHKNIGHT,ANY_FACTION,2569), -- Eternal Gladiator's Dreadplate Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2504,LEATHER,DEMONHUNTER,ANY_FACTION,2570), -- Eternal Gladiator's Felskin Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2510,LEATHER,DRUID,ANY_FACTION,2571), -- Eternal Gladiator's Dragonhide Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2516,MAIL,HUNTER,ANY_FACTION,2572), -- Eternal Gladiator's Chain Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2522,CLOTH,MAGE,ANY_FACTION,2573), -- Eternal Gladiator's Silk Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2528,LEATHER,MONK,ANY_FACTION,2574), -- Eternal Gladiator's Ironskin Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2534,PLATE,PALADIN,ANY_FACTION,2575), -- Eternal Gladiator's Scaled Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2540,CLOTH,PRIEST,ANY_FACTION,2576), -- Eternal Gladiator's Satin Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2546,LEATHER,ROGUE,ANY_FACTION,2577), -- Eternal Gladiator's Leather Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2552,MAIL,SHAMAN,ANY_FACTION,2578), -- Eternal Gladiator's Ringmail Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2558,CLOTH,WARLOCK,ANY_FACTION,2579), -- Eternal Gladiator's Felweave Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2564,PLATE,WARRIOR,ANY_FACTION,2580), -- Eternal Gladiator's Plate Armor, Elite
        IncludeSet(SetCollector.PVP,90200,2565,CLOTH,ANY_CLASS,ANY_FACTION), -- Eternal Aspirant's Vestment
        IncludeSet(SetCollector.PVP,90200,2566,LEATHER,ANY_CLASS,ANY_FACTION), -- Eternal Aspirant's Leathers
        IncludeSet(SetCollector.PVP,90200,2567,MAIL,ANY_CLASS,ANY_FACTION), -- Eternal Aspirant's Chain
        IncludeSet(SetCollector.PVP,90200,2568,PLATE,ANY_CLASS,ANY_FACTION), -- Eternal Aspirant's Plate
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
end
...
local function GetRaidAppearances()
    ...
    local sets = {
        -- Castle Nathria
        IncludeSet(SetCollector.RAID,90002,2150,PLATE,ANY_CLASS,ANY_FACTION,2152,2151,2153), -- Grand Sentinel's Greatplate, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90002,2154,MAIL,ANY_CLASS,ANY_FACTION,2155,2156,2157), -- Inexorable Castigator's Guise, Raid Finder, Heroic, Mythic
        IncludeSet(SetCollector.RAID,90002,2158,CLOTH,ANY_CLASS,ANY_FACTION,2160,2159,2161), -- Depraved Beguiler's Visage, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90002,2162,LEATHER,ANY_CLASS,ANY_FACTION,2164,2163,2165), -- Sin Slayer's Leathers, Heroic, Raid Finder, Mythic
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        IncludeSet(SetCollector.RAID,90100,2250,PLATE,ANY_CLASS,ANY_FACTION,2251,2252,2253), -- Soulforged Dreadplate, Raid Finder, Heroic, Mythic
        IncludeSet(SetCollector.RAID,90100,2254,MAIL,ANY_CLASS,ANY_FACTION,2256,2255,2257), -- Tower Ascendant's Battlegear, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90100,2258,LEATHER,ANY_CLASS,ANY_FACTION,2260,2259,2261), -- Sanctum Assailant's Trappings, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90100,2262,CLOTH,ANY_CLASS,ANY_FACTION,2263,2264,2265), -- Dark Supplicant's Garb, Raid Finder, Heroic, Mythic
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
    ...
    sets = {
        ...
        IncludeSet(SetCollector.RAID,90200,2348,PLATE,DEATHKNIGHT,ANY_FACTION,2350,2349,2351), -- The First Eidolon's Soulsteel, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2354,LEATHER,DEMONHUNTER,ANY_FACTION,2356,2355,2357), -- Mercurial Punisher's Painweave, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2360,LEATHER,DRUID,ANY_FACTION,2362,2361,2363), -- Tapestry of the Fixed Stars, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2366,MAIL,HUNTER,ANY_FACTION,2368,2367,2369), -- Godstalker's Battlegear, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2372,CLOTH,MAGE,ANY_FACTION,2374,2373,2375), -- Erudite Occultist's Vestments, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2378,LEATHER,MONK,ANY_FACTION,2380,2379,2381), -- Garb of the Grand Upwelling, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2384,PLATE,PALADIN,ANY_FACTION,2386,2385,2387), -- Luminous Chevalier's Gallantry, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2390,CLOTH,PRIEST,ANY_FACTION,2392,2391,2393), -- Habiliments of the Empyrean, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2396,LEATHER,ROGUE,ANY_FACTION,2398,2397,2399), -- Soulblade Shadowhide, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2402,MAIL,SHAMAN,ANY_FACTION,2404,2403,2405), -- Theurgic Starspeaker's Regalia, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2408,CLOTH,WARLOCK,ANY_FACTION,2410,2409,2411), -- Shroud of the Demon Star, Heroic, Raid Finder, Mythic
        IncludeSet(SetCollector.RAID,90200,2414,PLATE,WARRIOR,ANY_FACTION,2416,2415,2417), -- Armaments of the Infinite Infantry, Heroic, Raid Finder, Mythic
    }
    AddSetsToDatabase(VERSION, COLLECTION, sets)
end
